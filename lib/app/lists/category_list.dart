...
class CategoryList extends StatelessWidget {
  ...
  final Future<List<ModelCategory>> categoryList =
      DataFile.getBusinessLocationSeeAll();
            ...
            builder: (context, snapshot) {
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ModelCategory category = snapshot.data![index];
                  return buildItemCategoryDetailNetwork(context, category, () {
                    Get.bottomSheet(
                      Container(
                            ...
                            itemBuilder: (context, index) {
                              return Container(
                                margin: EdgeInsets.symmetric(
                                    horizontal:
                                        FetchPixels.getDefaultHorSpaceFigma(
                                            context),
                                    vertical: 10.h),
                                ...
                                child: InkWell(
                                  ...
                                  child: Row(
                                    children: [
                                      getCircularImage(context, 108.h,
